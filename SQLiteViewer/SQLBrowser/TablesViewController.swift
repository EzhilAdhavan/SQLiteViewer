...
class TablesViewController: UITableViewController {
    ...
    func copyTestDatabase() -> URL? {
        ...
        do {
            ...
            let target = docs.appendingPathComponent("projectsAndActivities40.sqlite")
            let source = Bundle.main.url(forResource: "projectsAndActivities40", withExtension: "sqlite")!
